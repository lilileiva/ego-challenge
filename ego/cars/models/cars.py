...
class Car(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, help_text="Date when car was created")
    udpated_at = models.DateTimeField(auto_now=True, help_text="Date when car was modified")
